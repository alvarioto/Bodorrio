...
const EventCard: React.FC<EventCardProps> = ({
  ...
  return (
    <Card
      className="bg-card/70 backdrop-blur-md text-card-foreground flex flex-col border-border/80 shadow-lg rounded-2xl w-full max-w-sm"
    >
      <CardContent className="p-6 flex-grow flex flex-col text-center items-center relative">
        ...
        <div className="w-full space-y-4 text-muted-foreground flex-grow flex flex-col items-center">
          <div className="w-full">
            <p className="font-bold text-foreground font-headline text-2xl tracking-wide">Día</p>
          ...
          <div className="w-full">
            <p className="font-bold text-foreground font-headline text-2xl tracking-wide">Lugar</p>
          ...
          <div className="w-full">
            <p className="font-bold text-foreground font-headline text-2xl tracking-wide">Dirección</p>
